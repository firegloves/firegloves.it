...
const GitHubLink = () => {
  ...
  return (
      <div
          className="absolute bottom-2 left-0 right-0 m-auto bg-white rounded-full p-1 pr-2 border-black border-2 w-fit fadeIn"
          style={{'--fade-delay': '1s'}}>
        <a
            ...
            href="https://github.com/firegloves/firegloves.it"
            target="_blank">
